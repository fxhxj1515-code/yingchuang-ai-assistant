...
const PROVIDER_PRESETS: Record<string, { name: string; baseUrl: string; type: ProviderType; apiFormat?: ApiFormat; autoDeviceId?: boolean }> = {
  ...
  yingchuang: { name: "映创云", baseUrl: "https://hwzs.club/api/ai/v1", type: "openai" },
};
